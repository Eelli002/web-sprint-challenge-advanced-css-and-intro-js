...
function get20s(arr){
  ...
  for (let i=0; i < arr.length; i++){
      yearsToIntegers = parseInt(arr[i].years);
  if (yearsToIntegers > 1900){
...
console.log(addArtist(artists, 20, 'Elijah Elliott', '1999-2020', 'Modern', 'American', 'Born in California in 1999...'));
